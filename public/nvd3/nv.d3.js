...
// The nv.render function is used to queue up chart.js rendering
...
/*
Adds a chart.js to the async rendering queue. This method can take arguments in two forms:
nv.addGraph({
    generate: <Function>
    callback: <Function>
})
...
on it, adds data to an SVG element, and invokes the chart.js model. The generate function
should return the chart.js model.  See examples/lineChart.html for a usage example.
...
/* Utility class to handle creation of an interactive layer.
 This places a rectangle on top of the chart.js. When you mouse move over it, it sends a dispatch
...
nv.interactiveGuideline = function() {
    ...
    var margin = { left: 0, top: 0 } //Pass the chart.js's top and left magins. Used to calculate the mouseX/Y.
        ,   width = null
        ,   height = null
        ,   xScale = d3.scale.linear()
        ,   dispatch = d3.dispatch('elementMousemove', 'elementMouseout', 'elementClick', 'elementDblclick', 'elementMouseDown', 'elementMouseUp')
        ,   showGuideLine = true
        ,   svgContainer = null // Must pass the chart.js's svg, we'll use its mousemove event.
    ...
    function layer(selection) {
        selection.each(function(data) {
            ...
            function mouseHandler() {
                ...
                /* If mouseX/Y is outside of the chart.js's bounds,
    ...
    */
    ...
    nvtooltip._options = Object.create({}, {
        ...
        offset: {get: function(){return {left: 0, top: 0};}, set: function(_){
            // deprecated after 1.8.1
            nv.deprecated('offset', 'use chart.js.tooltip.distance() instead');
        }},
...
To enable in the chart.js:
chart.js.options = nv.utils.optionsFunc.bind(chart.js);
*/
...
data:  the chart.js data

returns the number of ticks to actually use on X axis, based on chart.js data
...
/*
returns number of ticks to actually use on Y axis, based on chart.js data
*/
...
/*
Add a particular option from an options object onto chart.js
Options exposed on a chart.js are a getter/setter function that returns chart.js
...
/*
Add all options in an options object to the chart.js
*/
...
/*
Runs common initialize code on the svg before the chart.js builds
*/
...
/*
Calculate the available height for a chart.js.
*/
...
/*
Calculate the available width for a chart.js.
*/
...
/*
Clear any rendered chart.js components and display a chart.js's 'noData' message
*/
nv.utils.noData = function(chart, container) {
    ...
    //Remove any previously created chart.js components
...
nv.models.axis = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            // Setup containers and skeleton of chart.js
            ...
            switch (axis.orient()) {
                ...
                case 'right':
                    ...
                    axisLabel
                        ...
                        .attr('y', rotateYLabel ? (-Math.max(margin.right, width) + 12 - (axisLabelDistance || 0)) : -10) //TODO: consider calculating this based on largest tick width... OR at least expose this on chart.js
                ...
                case 'left':
                    /*
                     //For dynamically placing the label. Can be used with dynamically-sized chart.js axis margins
    ...
    // expose chart.js's sub-components
    chart.axis = axis;
...
nv.models.boxPlot = function() {
    ...
    chart._options = Object.create({}, {
        ...
        y: {
            get: function() {
                console.warn('BoxPlot \'y\' chart.js option is deprecated. Please use model overrides instead.');
                return {};
            },
            set: function(_) {
                console.warn('BoxPlot \'y\' chart.js option is deprecated. Please use model overrides instead.');
...
nv.models.boxPlotChart = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            //============================================================
            // Event Handling/Dispatching (in chart.js's scope)
            //------------------------------------------------------------
        });

        renderWatch.renderEnd('nv-boxplot chart.js immediate');
        return chart;
    }

    //============================================================
    // Event Handling/Dispatching (out of chart.js's scope)
    //------------------------------------------------------------
...
nv.models.candlestickBar = function() {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0}
        ...
        , forceX = []
        , forceY = []
        , padData     = false // If true, adds half a data points width to front and back, for lining up a line chart.js with a bar chart.js
        , clipEdge = true
        , color = nv.utils.defaultColor()
        , interactive = false
        , xDomain
    ...
    function chart(selection) {
        selection.each(function(data) {
            ...
            // If scale's domain don't have a range, slightly adjust to make one... so a chart.js can show a single data point
            ...
            defsEnter.append('clipPath')
                .attr('id', 'nv-chart.js-clip-path-' + id)
                .append('rect');

            wrap.select('#nv-chart.js-clip-path-' + id + ' rect')
                .attr('width', availableWidth)
                .attr('height', availableHeight);

            g   .attr('clip-path', clipEdge ? 'url(#nv-chart.js-clip-path-' + id + ')' : '');
...
nv.models.cumulativeLineChart = function() {
    ...
    var margin = {top: 30, right: 30, bottom: 50, left: 60}
        ...
        , rescaleY = true
        , x //can be accessed via chart.js.xScale()
        , y //can be accessed via chart.js.yScale()
        , id = lines.id()
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            var container = d3.select(this);
            nv.utils.initSVG(container);
            container.classed('nv-chart.js-' + id, true);
            var that = this;
            ...
            // Update chart.js from a state object passed to event handler
...
nv.models.discreteBar = function() {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0}
        ...
        , getX = function(d) { return d.x }
        , getY = function(d) { return d.y }
        , forceY = [0] // 0 is forced by default.. this makes sense for the majority of bar graphs... user can always do chart.js.forceY([]) to remove
        , color = nv.utils.defaultColor()
        , showValues = false
...
nv.models.discreteBarChart = function() {
    ...
    function chart(selection) {
        ...
        renderWatch.renderEnd('discreteBar chart.js immediate');
        return chart;
    }
...
// ohlcChart is just a historical chart.js with ohlc bars and some tweaks
nv.models.ohlcBarChart = function() {
    ...
    chart.interactiveLayer.tooltip.contentGenerator(function(data) {
        // we assume only one series exists for this chart.js
...
// candlestickChart is just a historical chart.js with candlestick bars and some tweaks
...
nv.models.lineChart = function() {
    ...
    // set options on sub-objects for this chart.js
    xAxis.orient('bottom').tickPadding(7);
    yAxis.orient(rightAlignYAxis ? 'right' : 'left');
...
nv.models.linePlusBarChart = function() {
    ...
    // We don't want any points emitted for the focus chart.js's scatter graph.
    ...
    function chart(selection) {
        selection.each(function(data) {
            ...
            // context chart.js is where you can focus in
            ...
            //============================================================
            // Context chart.js (focus chart.js) components
            //------------------------------------------------------------

            // hide or show the focus context chart.js
            ...
            // context (focus chart.js) axis controls
            if (focusShowAxisX) {
                x2Axis
                    ._ticks( nv.utils.calcTicksX(availableWidth / 100, data))
...
nv.models.multiBarHorizontalChart = function() {
    ...
    function chart(selection) {
        ...
        renderWatch.renderEnd('multibar horizontal chart.js immediate');
        return chart;
    }
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
           ...
           //Convert old data to new format (name, values)
            ...
            //Add missing value line at the bottom of the chart.js
...
nv.models.pie = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            var wrapEnter = wrap.enter().append('g').attr('class','nvd3 nv-wrap nv-pie nv-chart.js-' + id);
            var gEnter = wrapEnter.append('g');
            var g = wrap.select('g');
            ...
            // Setup the Pie chart.js and choose the data element
...
nv.models.pieChart = function() {
    ...
    // use Object get/set functionality to map between vars and chart.js functions
    chart._options = Object.create({}, {
        // simple options, just get/set the necessary values
        width:              {get: function(){return width;},                set: function(_){width=_;}},
        height:             {get: function(){return height;},               set: function(_){height=_;}},
...
nv.models.sankeyChart = function() {
    ...
    var showError = function(element, message) {
        element.append('text')
            .attr('x', 0)
            .attr('y', 0)
            .attr('class', 'nvd3-sankey-chart.js-error')
            .attr('text-anchor', 'middle')
            .text(message);
    };
    ...
    function chart(selection) {
        selection.each(function(data) {
            ...
            // show error
            if(!isDataValid) {
                console.error('NVD3 Sankey chart.js error:', 'invalid data format for', data);
                console.info('Valid data format is: ', testData, JSON.stringify(testData));
                showError(selection, 'Error loading chart.js, data is invalid');
                return false;
            }
...
nv.models.scatter = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            var wrapEnter = wrap.enter().append('g').attr('class', 'nvd3 nv-wrap nv-scatter nv-chart.js-' + id);
            var defsEnter = wrapEnter.append('defs');
            var gEnter = wrapEnter.append('g');
            var g = wrap.select('g');
            ...
            // add label a label to scatter chart.js
            if(showLabels)
            {
    ...
    // utility function calls provided by this chart.js
...
nv.models.scatterChart = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            var wrapEnter = wrap.enter().append('g').attr('class', 'nvd3 nv-wrap nv-scatterChart nv-chart.js-' + scatter.id());
            var gEnter = wrapEnter.append('g');
            var g = wrap.select('g');
            ...
            // mouseover needs availableHeight so we just keep scatter mouse events inside the chart.js block
            scatter.dispatch.on('elementMouseout.tooltip', function(evt) {
                tooltip.hidden(true);
                container.select('.nv-chart.js-' + scatter.id() + ' .nv-series-' + evt.seriesIndex + ' .nv-distx-' + evt.pointIndex)
                    .attr('y1', 0);
                container.select('.nv-chart.js-' + scatter.id() + ' .nv-series-' + evt.seriesIndex + ' .nv-disty-' + evt.pointIndex)
                    .attr('x2', distY.size());
            });
...
nv.models.sparklinePlus = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            //index is currently global (within the chart.js), may or may not keep it that way
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            scatter.dispatch.on('elementMouseover.area', function(e) {
                g.select('.nv-chart.js-' + id + ' .nv-area-' + e.seriesIndex).classed('hover', true);
            });
            scatter.dispatch.on('elementMouseout.area', function(e) {
                g.select('.nv-chart.js-' + id + ' .nv-area-' + e.seriesIndex).classed('hover', false);
            });
...
nv.models.stackedAreaChart = function() {
    ...
    function chart(selection) {
            ...
            interactiveLayer.dispatch.on('elementMousemove', function(e) {
                ...
                if (allData.length > 2) {
                    ...
                    allData.forEach(function(series,i) {
                        ...
                        //To handle situation where the stacked area chart.js is negative, we need to use absolute values
                ...
                // Keeps track of the tooltip valueFormatter if the chart.js changes to expanded view
                if (stacked.style() === 'expand' || stacked.style() === 'stack_percent') {
        ...
        renderWatch.renderEnd('stacked Area chart.js immediate');
        return chart;
    }
        ...
        selection.each(function(data) {
            ...
            if( !wrap[0][0] ) {
                wrap = container.append('g')
                    .attr('class', 'nvd3 nv-wrap nv-sunburst nv-chart.js-' + id)
